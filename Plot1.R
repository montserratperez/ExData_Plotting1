 ...
 hist (Test$Global_active_power, main= "Global Active Power", 
       xlab = "Global Active Power (kilowatts)", col = "red")
 
 #to call up the histogramm
 
 dev.copy(png, "GlobalActivePower.png", width =480, height = 480)
  
 #to print the histogram to png format
